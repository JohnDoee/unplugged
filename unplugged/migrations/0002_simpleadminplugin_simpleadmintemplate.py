    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_method', models.CharField(choices=[('full', 'Full'), ('modify_key', 'Modify Key')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auto_created_plugins', models.ManyToManyField(related_name='auto_created_plugins', to='unplugged.Plugin')),
                ('plugin', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='unplugged.Plugin')),
                ('template', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='unplugged.SimpleAdminTemplate')),
            ],
            options={
